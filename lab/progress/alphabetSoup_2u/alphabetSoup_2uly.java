import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class alphabetSoup_2uly extends PApplet {// information. reading a simple relation. alphabet city.
...
public void setup()
{
  ...
  book = loadBytes("ulysses.txt"); // book.length = 
  piso = height;
...
public void draw()
{
  ...
  {  
   ...
   for ( int j=0; j<num; j++ ){
    ...
    fill(0);
    textFont(font, 10); 
    text(PApplet.toChar(book[lector+j]), 12+(j+1)*10, height -10);   

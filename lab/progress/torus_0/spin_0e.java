import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class spin_0e extends PApplet {
// live in a torus
// daddydaddy im here!
// pacman or ultraman
...
float gravedad = 0.1f; // .8 es bueno pero probaremos definir una gravedad local  
//float gravedad = 0.0;   // mesa de billar                     
float elasticidad = 0.84f;  // afecta el rebote en general                        
...
class Pelota{
  ...
  Pelota(){
    radio = PApplet.toInt(random(20,20));
    masa = radio;
    atraccion = masa;

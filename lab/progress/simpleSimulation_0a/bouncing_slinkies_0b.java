import processing.core.*; import java.applet.*; import java.awt.*; import java.awt.image.*; import java.awt.event.*; import java.io.*; import java.net.*; import java.text.*; import java.util.*; import java.util.zip.*; public class bouncing_slinkies_0b extends PApplet {int selector = -1;
//int num = int(random(20,200));
int num =   100; // lavanderia
//int num = 3; //carambola
int piso, techo, pizq, pdere;

float gravedad = 0.80f;  
...
class Pelota{
  ...
  Pelota(){
    ...
    y = random(radio,techo + height-radio);
    velx = random(-2,2);
  }
